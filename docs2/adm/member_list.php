		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="local_ov01 local_ov">
					...
					&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn_01" onclick="location.href='./member_excel.php';">엑셀 다운로드</button>
				</div>
				...
				<div class="tbl_head01 tbl_wrap table-responsive">
					...
					<tr>
						...
						<th scope="col" id="mb_list_nick">회사명</th>
						<th scope="col" id="mb_list_nick">부서명</th>
						<!--<th scope="col" id="mb_list_mailr">인증여부</th>-->
					...
					<tr class="<?php echo $bg; ?>">
						...
						<td class="td_date"><div><?php echo $row['mb_company'] ?></div></td>
						<td class="td_date"><div><?php echo $row['mb_partname'] ?></div></td>
						<td headers="mb_list_mailr" style="display:none">
