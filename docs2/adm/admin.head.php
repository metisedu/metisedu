...
<header id="hd">
    ...
    <div id="hd_top">
       ...
       <div id="logo"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>"><img src="<?php echo G5_ADMIN_URL ?>/img/logo.png" alt="<?php echo get_text($config['cf_title']); ?> 관리자"></a></div>
        ...
        <div id="tnb">
            <ul>
                <li class="tnb_li"><a href="<?php echo G5_SHOP_URL ?>/" class="tnb_shop" title="SHOP 바로가기">SHOP 바로가기</a></li>
                <li class="tnb_li"><a href="<?php echo G5_URL ?>/index.php" class="tnb_community" title="사이트 바로가기">사이트 바로가기</a></li>
