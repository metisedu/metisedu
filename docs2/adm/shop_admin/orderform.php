...
<li  class="nav-item"><a href="#anc_sodr_list" class="nav-link">주문상품 목록</a></li>
<li  class="nav-item"><a href="#anc_sodr_pay" class="nav-link">주문결제 내역</a></li>
<li  class="nav-item"><a href="#anc_sodr_chk" class="nav-link">결제상세정보 확인</a></li>
<li  class="nav-item"><a href="#anc_sodr_paymo" class="nav-link">결제상세정보 수정</a></li>
<li  class="nav-item"><a href="#anc_sodr_memo" class="nav-link">상점메모</a></li>
<li  class="nav-item"><a href="#anc_sodr_orderer" class="nav-link">신청자 정보</a></li>
<!--<li  class="nav-item"><a href="#anc_sodr_taker" class="nav-link">받으시는 분</a></li>-->
</ul>';
...
<div class="card card-inverse card-flat">
	<div class="card-header">
		<div class="card-title">주문상품 목록</div>
	</div>
...
<div class="card card-inverse card-flat">
	<div class="card-header">
		<div class="card-title">주문결제 내역</div>
	</div>
	<div class="card-block">
		<div class="row">
			<div class="col-md-12">
...
<div class="card card-inverse card-flat">
	<div class="card-header">
		<div class="card-title">강의수강 내역</div>
	</div>
	<div class="card-block">
		<div class="row">
			<div class="col-md-12">
				<section id="anc_sodr_pay">
					...
					<div class="tbl_head01 tbl_wrap  table-responsive">
						...
						<table class="table">
						<caption>강의수강 내역</caption>
						<thead>
						<tr>
							<th scope="col">강의명</th>
							<th scope="col">강의코드</th>
							<th scope="col">전체 강의 수</th>
							<th scope="col">수강중인 강의 수</th>
						</tr>
						</thead>
						<tbody>
						<?php
						function get_lec_cnt($lt_id){
							global $od;

							$sQuery = " SELECT count(*) AS total
										,	(SELECT count(*) FROM han_member_movie WHERE mb_id = '".$od['mb_id']."' AND mv_id = b.mv_id AND cp_id = b.cp_id) AS use_cnt
										FROM han_shop_lec a, han_shop_movie b
						...
						$sQuery = " SELECT d.*
									FROM han_shop_cart a, han_shop_item b, han_shop_item_list c, han_shop_lec d
									WHERE (a.it_id = b.it_id)
									AND   (b.it_id = c.it_id)
									AND   (c.it_id2 = d.lt_id)
									AND   a.od_id = '".$od_id."'
									";
						$sql = sql_query($sQuery);

						for($i = 0; $row = sql_fetch_array($sql); $i++){
							$cnt = get_lec_cnt($row['lt_id']);

						?>
						<tr>
							<td class="td_paybybig"><?php echo get_text($row['it_name']); ?></td>
							<td class="td_paybybig"><?php echo get_text($row['lt_id']); ?></td>
							<td class="td_numbig"><?php echo number_format($cnt['total']); ?></td>
							<td class="td_numbig td_numsum"><?php echo number_format($cnt['use_cnt']); ?></td>
						</tr>
						<?php } ?>
						</tbody>
						</table>
...
<div class="card card-inverse card-flat">
	<div class="card-header">
		<div class="card-title">결제상세정보</div>
	</div>
	<div class="card-block">
		<div class="row">
			<div class="col-md-12">
				<section class="">
					...
					<div class="compare_wrap">
						...
						<section id="anc_sodr_chk" class="compare_left">
							...
							<div class="tbl_frm01  table-responsive">
								<table class="table">
