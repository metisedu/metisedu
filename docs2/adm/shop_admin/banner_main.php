...
?>
<style>
.tbl_frm01 table thead th, .tbl_frm01 table tbody td {text-align:center;}
</style>
...
<div class="btn_fixed_top">
	...
	<input type="button" value="배너추가" class="btn_03 btn" id="add_bn_main" accesskey="s">
</div>
