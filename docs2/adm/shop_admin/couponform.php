						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="tbl_frm01 tbl_wrap table-responsive">
									...
									<tr>
										<th scope="row">쿠폰발급</th>
										<td>
											<input type="radio" name="cp_method2" value="1" class="cp_method2" <?php if($cp['cp_method2'] == 1 || !$cp['cp_method2']) echo"checked"; ?>> 일반쿠폰
											<input type="radio" name="cp_method2" value="2" class="cp_method2 ml10" <?php if($cp['cp_method2'] == 2) echo"checked"; ?>> 난수번호생성
										</td>
									</tr>

									<tr class="single_area">
									...
									<tr class="rand_area">
										...
										<td><input type="text" name="cp_cnt" value="<?php echo $cp['cp_cnt']?>" class="frm_input" />
										</td>
									</tr>
									<tr class="rand_area">
										<th scope="row">난수자리수</th>
										<td>
											문자입력 <input type="text" name="cp_string" value="<?php echo $cp['cp_string']?>" class="frm_input" style="width:50px" />
											숫자입력 <input type="text" name="cp_int" value="<?php echo $cp['cp_int']?>" class="frm_input" style="width:50px" />
										</td>
									</tr>
								...
								<?php
								if($cp['cp_method2'] == '2'){
									$sql_common = " from g5_shop_coupon_log ";

									$sql_search = " where cp_id = '".$cp_id."' ";

									$sql_order = " order by cl_datetime ASC ";
								...
								<div class="member-count ">
									<ul>
										<li>총 <span><?php echo $total_count; ?></span>건</li>
									</ul>
								</div>
								...
								<div class="tbl_frm01 tbl_wrap">
									...
									<thead>
										<tr>
											...
											<th style="width:200px">사용시간</th>
										</tr>
									</thead>
									<tbody>
										<?php
											for($i = 0; $i < $row = sql_Fetch_array($result); $i++){
												$mb_id = ($row['mb_id'])? $row['mb_id']:"미사용";
												$cl_datetime = ($row['cl_datetime'] != '0000-00-00 00:00:00')? $row['cl_datetime']:"-";
										?>
										<tr>
											<td align="center"><?php echo ($i + 1); ?></td>
											<td><?php echo $row['rand_id']; ?></td>
											<td class=""><?php echo $mb_id; ?></td>
											<td class=""><?php echo $cl_datetime; ?></td>
										</tr>
										<?php
											}
											if($i == 0){
												echo"<tr>";
												echo"	<td colspan='4'>등록된 쿠폰내역이 없습니다</td>";
												echo"</tr>";
											}
										?>
									</tbody>
