		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="local_ov01 local_ov">
					...
					<span class="btn_ov01"><span class="ov_txt">전체 기타데이터</span><span class="ov_num"> <?php echo $total_count; ?>건</span></span>
				</div>

				<div class="btn_fixed_top">
					<a href="./contentform.php" class="btn btn_01">기타데이터 추가</a>
				</div>
