...
<article id="bo_v" style="width:<?php echo $width; ?>">
				...
				<tbody>
					<tr>
						<td class="td_subject" style="padding-left:20px">
										<a href="#" class="cate_link "><?php echo $view['ca_name']?></a>
										<div class="bo_tit">
							<a href="#"><?php echo $view['wr_subject']?></a>
						</div>
					</td>
					<td class="td_datetime"><?php echo $view['datetime']?></td>
					<td class="td_name sv_use"><span class="sv_member"><?php echo $view['wr_name']?></span></td>
    ...
    <?php } ?>
	<div class="btn_more">
		<a href="#" style="width:180px;margin:70px auto 70px auto;">목록보기</a>
	</div>
</article>
<!-- } 게시판 읽기 끝 -->
