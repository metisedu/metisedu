...
#faq_con .con_inner .closer_btn:first-child {
    top: 35px;
}
</style>
        ...
        <ol>
            ...
            <li>
                ...
                <div class="con_inner">
                    ...
                    <button type="button" class="closer_btn" <?php echo $style; ?>><i class="fa fa-minus" aria-hidden="true"></i><span class="sound_only">닫기</span></button>
                </div>
            </li>
            <?php
            }
