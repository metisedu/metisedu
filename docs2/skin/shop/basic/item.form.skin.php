...
<section id="sub_view_content">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="sub_detail_tit">강의소개</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-9">
				...
				<!-- 커리큘럼 시작 { -->
				<div class="sub_detail_content add_bottom_60">
					<div class="sub_detail_tit" style="border:0px;margin-bottom: 0px;">커리큘럼</div>
					<?php
					// 등록된 강의 정보 가져오기
					$sQuery = " SELECT *
							...
							<div class="cur_mv_list" style="">
								...
								?>
									<li>
										...
										<span class="s go_preview" data-id="<?php echo $rst['mv_id']; ?>"><i class="fa fa-circle"></i> 미리보기</span>
										<?php } ?>
									</li>
								<?php } ?>
								</ul>
				...
				<div class="box_style_4 sub_detail_action">
					...
					<div class="sub_detail_action_btn">
						...
						if ($is_orderable) {
							if($is_member){
						?>
						<button type="submit" onclick="document.pressed=this.value;" value="바로구매" class=" direct_buy">강의 구매하기</button>
						<button type="submit" onclick="document.pressed=this.value;" value="장바구니" class=" go_cart">장바구니</button>
						<?php
							}else{
						?>
						<button type="button" onclick="location.href='/login/';" class=" direct_buy">로그인</button>
						<button type="button" onclick="location.href='/bbs/register/';" class=" go_cart">회원가입</button>
						<?php
							}
						}
						?>
