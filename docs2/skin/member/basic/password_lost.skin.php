...
<section id="sub_password_lost">
	...
	반드시 마이페이지 내 회원정보에서 변경해 주세요.</span>
					...
					<input type="text" name="mb_email" id="mb_email" required class="required frm_input full_input email" size="30" placeholder="회원가입 시 등록된 이메일 정보를 입력해 주세요.">
					...
					<div class="reg_btn_wrap">
						<button type="submit" class="reg_btn">비밀번호 찾기</button>
					</div>
				</form>
				</div>
