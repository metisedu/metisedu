//----------------------------------
//   File          : js/pages/forms/form_noui_slider.js
//   Type          : JS file
//   Version       : 1.0.0
...
$(function() {
	...
	var default_size1 = document.getElementById('slider-default-lg'),
		default_size2 = document.getElementById('slider-default-default'),
		default_size3 = document.getElementById('slider-default-sm'),
		default_size4 = document.getElementById('slider-default-xs');

	noUiSlider.create(default_size1, handle_data);
	noUiSlider.create(default_size2, handle_data);
	noUiSlider.create(default_size3, handle_data);
	noUiSlider.create(default_size4, handle_data);
});
