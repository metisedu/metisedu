...
<div class="col-md-9 col-sm-12 col-xs-12 my_con">
	<div class="mypage-class">
		<div class="mypage-class-menu">
			<ul>
				<li><a href="/shop/orderinquiry/" class="active">결제내역</a></li>
				<li><a href="/shop/refund/" class="">환불내역</a></li>
			</ul>
		</div>
						...
						<div class="col-md-3">
							...
							<div class="payment_price">
								<dl>
									...
									<dt>할인금액</dt>
									<dd>-<?php echo number_format($row['od_cart_coupon'] + $row['od_coupon'])?>원</dd>
								</dl>
								<dl class="last">
									<dt>최종 결제금액</dt>
							...
							<div class="modal fade" id="refundModal" tabindex="-1" role="dialog" aria-labelledby="refundModalLabel" aria-hidden="true">
							  <div class="modal-dialog" role="document">
								<div class="modal-content">
								  ...
								  <br>
									안녕하세요! <?php echo $config['cf_title']; ?>입니다.<br><br>
