					...
					<div class="media" style="list-style:none;">
						...
						if($count > 0) {
							for($i=0; $row=sql_fetch_array($result); $i++) {
								...
								echo'<span class="coupon_text">'.get_text($row['cp_subject']).' <span class="coupon_price">'.number_format($dc).'원</span> <button type="button" class="od_cp_apply coupon_use">쿠폰사용하기</button></span>';
								echo'</li>';
							}
							...
							echo '<span class="coupon_text"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> 보유쿠폰이 없습니다</span>';
						}
						?>
						<!-- } 쿠폰 선택 끝 -->
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="media payment_method">
								...
								<div class="agree_box">
									<ul>
										<li><a href="javascript:void(0);" onclick="$(this).parent('li').children('div.agree_text').toggle();">1. <?php echo $config['cf_title']?> 이용약관 <span class="">보기 <i class="fa fa-angle-down" aria-hidden="true"></i></a></span>
										...
										<li><a href="javascript:void(0);" onclick="$(this).parent('li').children('div.agree_text').toggle();">2. 개인정보취급방침 <span class="">보기 <i class="fa fa-angle-down" aria-hidden="true"></i></a></span>
											<div class="agree_text">
											<?php
								...
								<div class="agree_check">
									...
									<label class="toggle">
									  ...
									  <span class="toggle__label">
										<span class="toggle__text">강의명, 가격 등을 확인 하였으며 이용약관에 모두 동의 합니다.</span>
									  </span>
									</label>
									</div>
				...
				<div class="box_style_4 sub_detail_action payment_aside">
					...
					<div class="payment_discount">
						...
						<dl>
							...
							<dt>쿠폰할인</dt>
							<dd>-<span id="od_cp_price">0</span>원</dd><!--ct_tot_coupon-->
						</dl>
...
function forderform_check(f)
{
	...
	*/
    ...
    check_field(f.od_b_name, "이름을 입력하십시오.");
    check_field(f.od_b_tel, "연락처를 입력하십시오.");
