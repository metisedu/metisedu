			...
			<div class="col-md-9 col-sm-12 col-xs-12 my_con">
				<div class="mypage-class">
					<div class="mypage-class-menu">
						<ul>
							<li><a href="/shop/mypage.php#class">수강중인 강의</a></li>
							<li><a href="/shop/cart.php" class="active">장바구니</a></li>
							<li><a href="/shop/mypage.php#done">수강 완료 강의</a></li>
						</ul>
					</div>
							...
							<tbody>
								...
								<tr class="item-list">
									...
									<td class="w15 text-right btn_wrap">
										...
										<a href="javascript:void(0);" class="text-center payment_btn">결제하기</a>
										<a href="javascript:void(0);" class="text-center delete_btn">삭제</a>
									</td>
								</tr>
								<?php
									$tot_point      += $point;
