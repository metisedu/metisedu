<?php
$text = '주식회사 한컴아카데미는 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
...
콘텐츠제공 , 구매 및 요금 결제 , 물품배송 또는 청구지 등 발송 , 금융거래 본인 인증 및 금융 서비스
...
o 위탁업무 내용 : 주문 상품 배송 및 고객상담 등 불만처리

o 위탁 대상자 : KG이니시스

o 위탁업무 내용 : 결제처리(휴대폰,무통장입금,계좌이체,신용카드 등 결제수단)
...
주식회사 한컴아카데미는다음과 같은 목적을 위해 쿠키를 사용합니다.
...
▶ 연락처 : 031-622-6128 / duhee.lee@hancom.com
