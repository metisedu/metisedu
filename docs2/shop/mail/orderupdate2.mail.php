...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        ...
        <tr>
            ...
            <td style="<?php echo $td_st; ?>"><a href="<?php echo shop_item_url($list[$i]['it_id']); ?>" target="_blank" style="text-decoration:none"><?php echo $list[$i]['it_name']; ?></a></td>
        </tr>
        <tr>
		...
		<?php if ($od_settle_case == '무통장') { ?>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">무통장입금</th>
            <td style="<?php echo $td_st; ?>">기업은행 012-503197-01-013 (주)한컴아카데미</td>
        </tr>
        <?php } ?>
        ...
        <table style="<?php echo $cont_st; ?>">
        <caption style="<?php echo $caption_st; ?>">신청하신 분 정보</caption>
        <colgroup>
            <col style="width:130px">
            <col>
        </colgroup>
        ...
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">이메일</th>
            <td style="<?php echo $td_st; ?>"><?php echo $od_email; ?></td>
        </tr>
        <tr>
        ...
        <a href="<?php echo G5_SHOP_URL.'/mypage.php'; ?>" target="_blank" style="<?php echo $ft_a_st; ?>">주문상세내역 확인</a>
