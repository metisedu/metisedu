	...
	<div class="box_style_4">
		<div class="media" style="">
			...
			<div class="media-body text-left profile_info">
				...
				<div class="profile_coupon">사용가능쿠폰 <a href="/shop/coupon.php" class="coupon_num"><?php echo number_format($cp_count); ?>개</a></div>
				<a href="/bbs/logout.php" class="profile_logout">로그아웃</a>
			</div>
			<div class="mypage-menu">
				<ul>
					<li><a href="/shop/mypage.php#class" class="<?php echo $act1; ?>">내 강의보기</a></li>
					<li><a href="/shop/coupon.php" class="<?php echo $act2; ?>">쿠폰내역</a></li>
					<li><a href="/shop/orderinquiry.php" class="<?php echo $act3; ?>">결제내역</a></li>
					<li><a href="/shop/mypage.php#done" class="<?php echo $act4; ?>">이전 수강정보</a></li>
					<li><a href="/bbs/member_confirm.php?url=register_form.php" class="<?php echo $act5; ?>">회원정보수정</a></li>
				</ul>
			</div>
		</div>
	</div>
