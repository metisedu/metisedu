...
<table class="table">
	...
	<tbody>
		...
		<tr class="item-list">
			...
			<td class="w15 text-center btn_wrap"><a href="/shop/mypage_view.php?od_id=<?php echo $row['od_id']; ?>&amp;ct_id=<?php echo $row['ct_id']; ?>&amp;uid=<?php echo $uid; ?>" class="btn_course">수강하기</a></td>
		</tr>
		<?php
		}
		if($i == 0){
			echo"<tr><td colspan='3' style='text-align:center;width:100%;padding:100px;0px'>수강중인 강의가 없습니다</td></tr>";
		}
		?>
	</tbody>
</table>