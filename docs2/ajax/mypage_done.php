...
<table class="table">
	...
	<tbody>
		...
		<tr class="item-list">
			...
			<td class="w25 text-center period">기간만료</td>
			<td class="w15 text-center btn_wrap"><a href="<?php echo $item_link_href; ?>" class="btn_class_complete">다시수강하기</a></td>
		</tr>
		<?php
		}
		if($i == 0){
			echo"<tr><td colspan='3' style='text-align:center;width:100%;padding:100px;0px'>수강 완료된 강의가 없습니다</td></tr>";
		}
		?>
	</tbody>
</table>