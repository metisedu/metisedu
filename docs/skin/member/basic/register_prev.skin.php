	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 add_bottom_60 text-center">
				...
				<span class="sub-top-stitle">Membership is divided into two categories: general membership and tutor membership</span>
				<div class="prev-register">
					<ul>
						<li>
							<a href="/bbs/register.php">
								<img src="/theme/lms/img/ico_register_1.png" alt="일반" />
								<p><strong>General</strong> <i>&#8640;</i><br>Sign up</p>
							</a>
						</li>
						<li>
							<a href="/bbs/register.php?type=tutor">
								<img src="/theme/lms/img/ico_register_2.png" alt="튜터" />
								<p><strong>Tutor</strong> <i>&#8640;</i><br>Sign up</p>
							</a>
						</li>
					</ul>
				</div>
