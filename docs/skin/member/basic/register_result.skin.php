	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 add_bottom_60 text-center">
				<span class="sub-top-title"><!-- 회원 가입을 축하합니다. -->Congratulations on your membership.
				<!-- <br /><?php echo get_text($mb['mb_id']); ?> 님의 지식 레벨업을 위한 쿠폰이 지급되었습니다. -->
				</span>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 add_bottom_60 text-center">
				...
				<a href="/" class="long_more_class"><!-- 튜터등록하기 -->Register Tutor</a>
			</div>
		</div>
	</div>
</div>
