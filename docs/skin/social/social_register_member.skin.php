...
<div class="mbskin" id="register_member">
    ...
    <div class="all_agree">
		...
		<label class="toggle" style="border:0px;background:#fff;">
		  <input type="checkbox" name="chk_all" value="1" id="chk_all" value="1" class="selec_chk toggle__input">
		  <span class="toggle__label">
			<span class="toggle__text"><strong>전체약관에 동의합니다.</strong></span>
		  </span>
		</label>
		</div>
    </div>
