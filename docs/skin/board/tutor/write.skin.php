...
<section id="bo_w">
    ...
    <div class="bo_w_info write_div">
	    ...
	    <?php if ($is_homepage) { ?>
	        ...
	        <input type="text" name="wr_homepage" value="<?php echo $homepage ?>" id="wr_homepage" class="frm_input half_input" size="50" placeholder="Homepage">
	    <?php } ?>
	</div>
    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="autosave_wrapper" class="write_div">
            ...
            <button type="button" id="btn_autosave" class="btn_frmline">A temporary saved article (<span id="autosave_count"><?php echo $autosave_count; ?></span>)</button>
            <div id="autosave_pop">
                <strong>A temporary saved article</strong>
                <ul></ul>
	...
	<div class="write_div">
        <label for="wr_1" class="sound_only">Information<strong>필수</strong></label>
	<input type="text" name="wr_1" value="<?php echo $wr_1?>" id="wr_1" required="" class="frm_input full_input required" placeholder="Information" >
	</div>
	
	<div class="write_div">
        <label for="wr_content" class="sound_only">D-day for voting<strong>필수</strong></label>
		<input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input full_input required" placeholder="D-day for voting">
	</div>
