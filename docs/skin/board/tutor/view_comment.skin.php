...
<button type="button" class="cmt_btn"><span class="total"><b><!-- 댓글 -->Comments</b> <?php echo $view['wr_comment']; ?></span><span class="cmt_more"></span></button>
<!-- 댓글 시작 { -->
<section id="bo_vc">
    <h2>댓글목록</h2>
    <?php
    ...
    <?php } ?>
    <?php if ($i == 0) { //댓글이 없다면 ?><p id="bo_vc_empty"><!-- 등록된 댓글이 없습니다. -->There are no comments</p><?php } ?>
...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <textarea id="wr_content" name="wr_content" maxlength="10000" required class="required" title="내용" placeholder="You can add comments"
    ...
    <div class="bo_vc_w_wr">
        ...
        <div class="btn_confirm">
        	<span class="secret_cm chk_box">
	            ...
	            <label for="wr_secret"><span></span><!-- 비밀글 -->Hidden comments</label>
            </span>
            <button type="submit" id="btn_submit" class="btn_submit"><!-- 댓글등록 -->Resgister comments</button>
        </div>
    </div>
    </form>
</aside>
