...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        for ($i=0; $i<count($list); $i++) {
			$list[$i]['href'] = "/adm/bbs/board.php?bo_table=".$bo_table."&wr_id=".$list[$i]['wr_id'];
         ?>
    ...
    <fieldset id="bo_sch">
        ...
        <button type="submit" value="검색" class="sch_btn" style="padding: 0px 10px;"><i class="fa fa-search" aria-hidden="true"></i><span class="sound_only">검색</span></button>
        </form>
    </fieldset>
    <!-- } 게시판 검색 끝 -->
</div>
