...
<section id="bo_w">
	...
	<div class="bo_w_select write_div">
        <label for="wr_1"  class="sound_only">분류<strong>필수</strong></label>
        <input type="text" name="wr_1" id="wr_1" value="<?php echo $write['wr_1']; ?>" placeholder="공지 하실 판매용상품 코드를 입력해 주세요." class="frm_input" size="90" />
    </div>
