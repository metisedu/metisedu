...
$mb_email       = trim($_POST['mb_id']); //trim($_POST['mb_email']);
...
$mb_fb          = isset($_POST['mb_fb'])            ? trim($_POST['mb_fb'])          : "";
$mb_in          = isset($_POST['mb_in'])            ? trim($_POST['mb_in'])          : "";
$mb_yt          = isset($_POST['mb_yt'])            ? trim($_POST['mb_yt'])          : "";
$mb_ho          = isset($_POST['mb_ho'])            ? trim($_POST['mb_ho'])          : "";

$mb_company		= isset($_POST['mb_company'])		? trim($_POST['mb_company'])		: "";
$mb_partname	= isset($_POST['mb_partname'])		? trim($_POST['mb_partname'])		: "";
$mb_position	= isset($_POST['mb_position'])		? trim($_POST['mb_position'])		: "";
$mb_route		= isset($_POST['mb_route'])			? trim($_POST['mb_route'])          : "";
$mb_interest1	= isset($_POST['mb_interest1'])		? trim($_POST['mb_interest1'])		: "";
$mb_interest2	= isset($_POST['mb_interest2'])		? trim($_POST['mb_interest2'])		: "";
$mb_interest3	= isset($_POST['mb_interest3'])		? trim($_POST['mb_interest3'])		: "";

$mb_marketing   = isset($_POST['agree4'])           ? trim($_POST['agree4'])         : "";
...
$mb_fb		    = clean_xss_tags($mb_fb);
$mb_in		    = clean_xss_tags($mb_in);
$mb_yt		    = clean_xss_tags($mb_yt);
$mb_ho		    = clean_xss_tags($mb_ho);
...
if ($w == '') {
    $sql = " insert into {$g5['member_table']}
                set mb_id = '{$mb_id}',
					 ...
					 mb_partname = '{$mb_partname}',
					 mb_position = '{$mb_position}',
					 mb_route = '{$mb_route}',
					 mb_interest1 = '{$mb_interest1}',
					 mb_interest2 = '{$mb_interest2}',
					 mb_interest3 = '{$mb_interest3}',
