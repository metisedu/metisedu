			...
			<div class="col-md-9">
				<div class="mypage-class">
					<div class="mypage-class-menu">
						<ul>
							<li><a href="/sub/payment-log/" class=""><!-- 결제내역 -->Payment list</a></li>
							<li><a href="/sub/payment-refund/" class="active"><!-- 환불내역 -->Refund</a></li>
						</ul>
					</div>
					...
					<div class="mypage-payment-list no-after">
						<div class="class-filter">
							...
							<div class="col-md-6">
								<div class="period">
									<ul>
										<li><a href="#" class="active"><!-- 3개월 -->3 months</a></li>
										<li><a href="#" class=""><!-- 6개월 -->6 months</a></li>
										<li><a href="#" class=""><!-- 12개월 -->12 months</a></li>
									</ul>
								</div>
							</div>
							<div class="col-md-6">
								...
								<div class="row">
									...
									<div class="col-md-3">
										...
										<div class="payment_price">
											<dl>
												<dt>결제금액</dt>
												<dd><?php echo number_format(500000)?><!-- 원 -->MTS</dd>
												<dt>공제금액</dt>
												<dd>-<?php echo number_format(100000)?><!-- 원 -->MTS</dd>
											</dl>
											<dl class="last">
												<dt>최종 환불금액</dt>
												<dd><?php echo number_format(300000)?><!-- 원 -->MTS</dd>
											</dl>
										</div>										
									</div>
									<div class="col-md-5">
