...
<?php if ($_GET["force_agent"] == "app") { ?>
    <script>
        localStorage.setItem("FORCEAGENT", "app");
    </script>
<?php } ?>
	...
	<div class="container">
		<div class="row">
			<div class=" col-md-10 col-md-offset-1 text-center">
				<form name="fsearchbox" id="fsearch" method="get" action="<?php echo G5_SHOP_URL ?>/search.php" onsubmit="return search_submit(this);">
					<label for="sch_str" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label>
					<input type="text" name="q" id="sch_str" class="main_search" placeholder="Search">
...
<section id="main_movie" style="display:none;">
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center">
				<?php
				...
				<div id="bt_movie" style="">
					<ul class="hidden-sm hidden-xs">
						...
						<li class="btn_more2 hidden-sm hidden-xs">
							<a href="<?php echo $mv_url; ?>" target="_blank"><!-- 유튜브 바로가기 -->See Introduction</a>
						</li>
					</ul>
