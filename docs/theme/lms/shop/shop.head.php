...
<!-- 커뮤니티 왼쪽메뉴 /theme/lms/community.left.php -->
...
<header>
	...
	<div class="container">
		<div class="row hidden-lg hidden-md">
			...
			<div class="m_area">
				<div class="m_close" style="text-align:right;font-size:2em;">
		...
		<div class="row hidden-sm hidden-xs">
			...
			<div class="col-md-10">
				...
				<ul class="sf-menu sf-js-enabled sf-arrows" style="z-index: 10000;">
					...
					<?php if ($is_member) {  ?>
					<li class="mypage"><a href="<?php echo G5_BBS_URL ?>/logout.php" class="first">Logout</a><a href="<?php echo G5_SHOP_URL ?>/mypage.php">Mypage</a> | <a href="<?php echo G5_URL ?>/bbs/write.php?bo_table=tutor">Tutor</a></li>
					<?php if ($is_admin) {  ?>
					...
					<?php }  ?>
					<?php } else {  ?>
					<li class="mypage"><a href="<?php echo G5_BBS_URL ?>/login.php" class="first">Login</a><a href="<?php echo G5_BBS_URL ?>/register_prev.php">Sign up</a> | <a href="<?php echo G5_URL ?>/poll_tutor.php">Tutor</a></li></li>
					<?php }  ?>
				</ul>
				<!--
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-5 text-right">
				<form name="fsearchbox" id="fsearch" method="get" action="<?php echo G5_SHOP_URL ?>/search.php" onsubmit="return fsearchbox_submit(this);">
					<label for="sch_stx" class="sound_only">검색어 필수</label>
					<input type="text" name="q" id="sch_stx" class="main_search" placeholder="Search" autocomplete="off" value="<?php echo $_GET['q']?>">
