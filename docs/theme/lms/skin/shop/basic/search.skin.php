    ...
    <div id="ssch_frm">
		<div class="ssch_frm_inner">
	        ...
	        <div class="ssch_option">
	            ...
	            <strong class="sound_only">상품가격 (MTS)</strong>
	            <label for="ssch_qfrom" class="sound_only">최소 가격</label>
	            <input type="text" name="qfrom" value="<?php echo $qfrom; ?>" id="ssch_qfrom" class="ssch_input" size="10"> MTS ~
	            <label for="ssch_qto" class="sound_only">최대 가격</label>
	            <input type="text" name="qto" value="<?php echo $qto; ?>" id="ssch_qto" class="ssch_input" size="10"> MTS
	        </div>
        	</form>
		</div>
		<!-- 검색된 분류 시작 { -->
