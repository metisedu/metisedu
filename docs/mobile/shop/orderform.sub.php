					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="media payment_method">
                                ...
                                if(true) {
                                    $multi_settle++;
                                    echo '<input type="radio" id="od_settle_metis_metamask" name="od_settle_case" value="METISMETAMASK" '.$checked.'> <label for="od_settle_metis_metamask" class="lb_icon bank_iconx">MTS 결제</label>'.PHP_EOL;
                                    $checked = '';
                                }
