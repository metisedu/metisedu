...
if (defined('G5_IS_ADMIN')) {
    if(!defined('_THEME_PREVIEW_')) {
		...
		/*
		echo '<link rel="stylesheet" href="'.run_replace('head_css_url', '/dashboard/lib/css/bootstrap.css?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
		echo '<link rel="stylesheet" href="'.run_replace('head_css_url', '/dashboard/lib/css/main.css?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
		*/
	}
...
if (defined('G5_IS_ADMIN')) {
    if(!defined('_THEME_PREVIEW_')) {
		add_javascript('<script src="'.G5_JS_URL.'/jquery.js"></script>', 0);
	}
}else{
