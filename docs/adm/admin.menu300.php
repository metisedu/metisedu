...
$menu['menu300'] = array (
	...
	//array('300130', '주문내역(투표컨텐츠)', G5_ADMIN_URL.'/shop_admin/orderlist_vote.php', 'scf_order', 1),
	array('300150', '튜터게시판관리', G5_ADMIN_URL.'/tutor_list.php', 'scf_order', 1),
	array('300160', '리워드지급', G5_ADMIN_URL.'/reward_mem_list.php', 'scf_order', 1),
	array('300161', '리워드로그', G5_ADMIN_URL.'/reward_list.php', 'scf_order', 1)
);
