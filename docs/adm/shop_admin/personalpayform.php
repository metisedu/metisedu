...
<li class="nav-item"><a href="#anc_spp_info" class="nav-link">주문 정보</a></li>
<li class="nav-item"><a href="#anc_spp_pay" class="nav-link">결제 정보</a></li>
</ul>';
