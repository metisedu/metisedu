...
<section id="anc_scf_per">
    <h2 class="h2_frm">기본 퍼센트요율</h2>
    <?php echo $pg_anchor; ?>
    <div class="local_desc02 local_desc">
        <p>요율이 정해지지 않은 상품은 기본 요율이 적용 됩니다.</p>
    </div>

    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption>기본 퍼센트요율</caption>
        <colgroup>
            <col class="grid_4">
            <col>
        </colgroup>
        <tbody>
        <tr>
            <th scope="row"><label for="de_shop_skin">기본 퍼센트요율</label></th>
            <td>
               <p style="margin:10px">
					<span style="width:100px;display:inline-block;">플랫폼</span>:
					<input type="text" class="frm_input onlynumber de_per" name="de_per_platform" id="de_per_platform" value="<?php echo $default['de_per_platform']; ?>" style="width:100px;" /> %
				</p>
				<p style="margin:10px">
					<span style="width:100px;display:inline-block;">콘텐츠제공자</span>:
					<input type="text" class="frm_input onlynumber de_per" name="de_per_offerer" id="de_per_offerer" value="<?php echo $default['de_per_offerer']; ?>" style="width:100px;" /> %
				</p>
				<p style="margin:10px">
					<span style="width:100px;display:inline-block;">추천인(Mother)</span>:
					<input type="text" class="frm_input onlynumber de_per" name="de_per_recommend" id="de_per_recommend" value="<?php echo $default['de_per_recommend']; ?>" style="width:100px;" /> %
				</p>
				<p style="margin:10px">
					<span style="width:100px;display:inline-block;">결제자(son)</span>:
					<input type="text" class="frm_input onlynumber de_per" name="de_per_payer" id="de_per_payer" value="<?php echo $default['de_per_payer']; ?>" style="width:100px;" /> %
				</p>
				...
				<p style="margin:10px">
					...
					<input type="text" class="frm_input onlynumber de_per" name="de_per_voter" id="productDeliveryPrice" value="<?php echo $default['de_per_voter']; ?>" style="width:100px;" /> %
				</p>
            </td>
        </tr>
        </tbody>
