...
<li class="nav-item"><a href="#anc_scatefrm_basic" class="nav-link">필수입력</a></li>
<li class="nav-item"><a href="#anc_scatefrm_optional" class="nav-link">선택입력</a></li>
<li class="nav-item"><a href="#anc_scatefrm_extra" class="nav-link">여분필드</a></li>';
if ($w == 'u') $pg_anchor .= '<li class="nav-item"><a href="#frm_etc" class="nav-link">기타설정</a></li>';
$pg_anchor .= '</ul>';
					...
					<div class="tbl_frm01 tbl_wrap table-responsive">
						...
						<tr>
							...
							<?php } else { ?>
								...
								<a href="./categoryform.php?ca_id=<?php echo $ca_id; ?>&amp;<?php echo $qstr; ?>" class="btn_frmline">중분류 추가</a>
