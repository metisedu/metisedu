...
'de_per_platform',					// 상품 퍼센트 요율 기본 플랫폼, 
'de_per_offerer',
'de_per_recommend',
'de_per_payer',
'de_per_voter'
...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$de_admin_company_owner}',
				...
				de_per_platform = '".$de_per_platform."',
				de_per_offerer = '".$de_per_offerer."',
				de_per_recommend = '".$de_per_recommend."',
				de_per_payer = '".$de_per_payer."',
				de_per_voter = '".$de_per_voter."'
                ";
sql_query($sql);
