...
<form name="searchForm" action="?" class="local_sch03 local_sch" method="get">
	<div class="sch_last">	
		<select name="sfl" id="sfl">
			<option value="mb_id"<?php echo get_selected($_GET['sfl'], "mb_id"); ?>>등록자</option>
		</select>
...
<form name="frm" id="frm" action="./han_write_tutor_update.php" onsubmit="return frm_submit(this);" method="post">
	...
	<div class="tbl_head01 tbl_wrap">
		...
		<tr>
			...
			<th scope="col"><?php echo subject_sort_link('reward_date') ?>등록일</th>
			<th scope="col">등록자</th>
		...
		<tr class="<?php echo $bg; ?>">
			...
			<td class=""><?php echo $row['wr_datetime']?></td>
			<td class=""><?php echo $row['mb_id']?></td>
			

			<td class=""><?php echo $row['wr_good']?></td>
			<td class=""><?php echo $row['wr_nogood']?></td>

			<td class=""><?php echo $row['wr_2']?></td>
			<td class=""><?php echo $row['wr_3']?></td>

			<td>
				<a href="./tutor_form.php?<?php echo $qstr;?>&amp;w=u&amp;wr_id=<?php echo $row['wr_id'];?>" class="btn btn_03">수정</a>
				<button type="button" onclick="account_delete('<?php echo $qstr;?>', '<?php echo $row["wr_id"];?>')" class="btn btn_03">
					삭제
				</button>
			</td>
