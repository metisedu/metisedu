...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        showZoom: true,
        showDrag: true,
        removeIcon: '<i class="icon-bin text-danger"></i>',
        removeClass: 'btn btn-xs btn-secondary',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="icon-cloud-upload text-success"></i> ',
        uploadClass: 'btn btn-xs btn-secondary',
        uploadTitle: 'Upload file',
        zoomIcon: '<i class="icon-eye8"></i>',
        zoomClass: 'btn btn-xs btn-secondary',
    ...
    tFileIcon = '<i class="icon-file-empty2 kv-caption-icon"></i> ';
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="icon-arrow-left12"></i>',
            next: '<i class="icon-arrow-right13"></i>',
            toggleheader: '<i class="icon-arrow-resize8"></i>',
        ...
        previewZoomButtonClasses: {
            ...
            toggleheader: 'btn btn-secondary btn-header-toggle',
            fullscreen: 'btn btn-secondary',
            borderless: 'btn btn-secondary',
