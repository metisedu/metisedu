...
1,f.length):(c>b&&(r=b,b=c,c=r),f.splice(b+1,f.length),f.splice(0,c)),a[d](h,{selected:!0}).any())?(f.splice(e.inArray(h,f),1),a[d+"s"](f).deselect()):a[d+"s"](f).select():(c=a[d+"s"]({selected:!0}),f&&1===c.flatten().length?a[d](h).deselect():(c.deselect(),a[d](h).select())):a[d](h).select(!f)}function o(c,a){return function(b){return b.i18n("buttons."+c,a)}}var g=e.fn.dataTable;g.select={};g.select.version="2.0.0";e.each([{type:"row",prop:"aoData"},{type:"column",prop:"aoColumns"}],function(c,a){g.ext.selector[a.type].push(function(b,
