$(function() {
    ...
    function initialize() {
        ...
        var mapOptions = {
			...
			icon: 'https://www.ecopharma.ch/typo3conf/ext/gmap/Resources/Public/Icons/blueMarker.png',
        }
    ...
    function setMarkers(map, locations) {
        var image = {
            url: 'https://www.ecopharma.ch/typo3conf/ext/gmap/Resources/Public/Icons/blueMarker.png',
