			...
			<div class="col-md-9 col-sm-12 col-xs-12 my_con">
				<div class="mypage-class">
					<div class="mypage-class-menu">
						<ul>
							<li class="my_tab_btn" data-id="class"><a href="/shop/mypage.php#class"><!-- 수강중인 강의 -->Course</a></li>
							<li><a href="/shop/cart.php"><!-- 장바구니 -->Cart</a></li>
							<li class="my_tab_btn" data-id="done"><a href="/shop/mypage.php#done"><!-- 수강 완료 강의 -->Finished course</a></li>
						</ul>
					</div>
					<!-- 수강중인 강의 -->
