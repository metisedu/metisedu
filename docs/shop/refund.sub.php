...
<div class="col-md-9">
	<div class="mypage-class">
		<div class="mypage-class-menu">
			<ul>
				<li><a href="/shop/orderinquiry.php" class=""><!-- 결제내역 -->Payment list</a></li>
				<li><a href="/shop/refund.php" class="active"><!-- 환불내역 -->Refund</a></li>
			</ul>
		</div>
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div class="item-list-name">
								...
								<span class="date"><!-- 구매일 -->Order <?php echo substr($row['od_time'],2,14); ?></span>
							</div>
						</div>
						<div class="col-md-3">
							...
							<div class="payment_price">
								<dl>
									...
									<dt>공제금액</dt>
									<dd>-<?php echo number_format(0)?> won</dd>
								</dl>
								<dl class="last">
									<dt>최종 환불금액</dt>
