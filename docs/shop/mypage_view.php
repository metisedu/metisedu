		...
		<div class="row">
			...
			<div class="col-md-7">
				<div class="course_review">
					...
					<form name="fitemuse" method="post" action="./itemuseformupdate.php" onsubmit="return fitemuse_submit(this);" autocomplete="off" enctype="multipart/form-data">
						...
						<textarea name="is_content" placeholder="Please enter the text" class="review_content"></textarea>
						...
						<label for="wr_file" class="wr_file"><!-- 이미지첨부 -->Image attachment <span><!-- (200kb이하 파일만 등록가능합니다) -->(only files below 200kb can be attatched.)</span></label>
						...
						for($i = 5; $i >= 1; $i--){
							...
							echo'<option value="'.$i.'">'.$i.' point</option>';
						}
						?>
						</select>
						<button type="submit" class="review_submit"><!-- 등록하기 -->Submit</button>
						</form>
					</div>
					<div class="sub_detail_review add_bottom_60">
						<div id="comments">
						...
						<div class="btn_more"><a href="/shop/review.php"><!-- 다른 수강평 더보기 -->See more other course reviews</a></div>
						<!-- <div class="btn_more"><a href="/shop/review.php" style="width:180px;margin:70px auto 70px auto;">See more other course reviews</a></div> -->
			...
			<div class="col-md-5">
				<div class="course_notice">
					<div class="course_small_tit"><!-- 클래스 첨부파일 -->Class Attachment</div>
					<ul>
						<?php
						// 등록된 강의 정보 가져오기
						$sQuery = " SELECT *
						...
						?>
							...
							if($j == 0)
								echo"<a href='javascript:void(0);'><i class=\"fa fa-download\"></i> <span>There are no registered attachments.</span></a>";
							?>
							</li>
						<?php
							}
				...
				<div class="course_notice" style="border-top:0px;">
					<div class="course_small_tit"><!-- 클래스 공지 -->Notice Class </div>
					<ul>
						<?php
						$sQuery = " SELECT *
						...
						if($i == 0) echo "<li>There are no notices.</li>";
						?>
					</ul>
				</div>
			</div>
...
function get_mv_url(){
	$("#kollus_mv").attr("src", "https://player.vimeo.com/video/"+im_key);
	/*
	$.ajax({
		type:"post",
