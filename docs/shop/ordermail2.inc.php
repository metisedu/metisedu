...
mailer($od_name, $od_email, $default['de_admin_info_email'], $subject, $content, 1);
//------------------------------------------------------------------------------
...
mailer($config['cf_admin_email_name'], $default['de_admin_info_email'], $od_email, $subject, $content, 1);
//------------------------------------------------------------------------------
...
for ($i=0; $row=sql_fetch_array($result); $i++)
{
    ...
    mailer($config['cf_admin_email_name'], $default['de_admin_info_email'],  $row['it_sell_email'], $subject, $content, 1);
}
//==============================================================================
?>