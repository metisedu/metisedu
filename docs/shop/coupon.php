				...
				<div class="mypage-class">
					...
					<div class="mypage-coupon-list responsive">
						<div class="mypage-coupon-input">
							<!-- 쿠폰번호 입력 -->Enter Coupon Number <input type="text" name="cp_id" id="cp_id" class="frm_input"> <button type="button" onclick="get_coupon_check();"><!-- 쿠폰등록 -->Register</button>
						</div>

						<table class="table" style="display:;">
							<thead>
								<tr>
									<th><!-- 쿠폰 명 -->Coupon Name</th>
									<th style="width:17%"  class="text-center"><!-- 종류 -->Coupon details</th>
									<th style="width:33%" class="text-center"><!-- 기간 -->Period</th>
							...
							<tbody>
								...
								<tr class="item-list">
									...
									<td class="text-center period">남은기간 : <?php echo date("Y.m.d", strtotime($row['cp_end'])); ?> / <?php echo $leftDate; ?>일남음</td>
